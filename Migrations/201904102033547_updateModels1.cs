namespace BatemanCafeteria.Migrations
{
    ...
    public partial class updateModels1 : DbMigration
    {
        ...
        {
            AddColumn("Caf_MenuItemModel", "Category", c => c.String(nullable: false, unicode: false));
            DropForeignKey("Caf_MenuItemModel", "CategoryId", "Caf_FoodCategories");
            DropIndex("Caf_MenuItemModel", new[] { "CategoryId" });
            DropColumn("Caf_MenuItemModel", "CategoryId");
            DropTable("Caf_FoodCategories");
        }
    }
}
